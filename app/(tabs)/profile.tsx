import { View, Text, ImageBackground, StyleSheet, StatusBar, Pressable, ScrollView, Dimensions, TouchableOpacity, Alert } from 'react-native'
    ...
    >
      ...
      <View style={styles.overlay}>
        <SafeAreaView style={styles.container} edges={['top']}>
          <View style={{alignItems:'flex-start', marginVertical:10, alignSelf:'center'}}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.buttonSpacing}>
                <Pressable style={styles.actionButton}>
                  ...
                  <Ionicons name='chevron-forward' size={26} color={'rgb(216, 216, 216)'} />
                </Pressable>
              </View>
              ...
              <View style={styles.referralSection}>
                ...
                <View style={styles.referralCodeContainer}>
                  <View style={styles.codeBox}>
                    <Ionicons name='gift' size={20} color={'#f59e0b'} style={{marginRight: 10}} />
                ...
                <Text style={styles.referralSubtext}>Share with friends to earn rewards</Text>
              </View>
            ...
            <View style={styles.accountCard}>
              ...
              <Pressable style={styles.logoutButton}>
                ...
                <Ionicons name='chevron-forward' size={26} color={'rgb(26, 26, 26)'} />
              </Pressable>
            </View>
